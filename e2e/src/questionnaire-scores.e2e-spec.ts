...
describe(('treadwill questionnaire-scores'), () => {
    ...
    it('should show phq-9 graph and content', () => {
        ...
        browser.sleep(5000);
        expect(scoresPage.getPhqHeadingText()).toEqual('PHQ-9 score at the starting of each module');
        browser.sleep(1000);
    });
    ...
    it('should go back and now select gad-7 card', () => {
        ...
        browser.sleep(5000);
        expect(scoresPage.getGadHeadingText()).toEqual('GAD-7 score at the starting of each module');
        browser.sleep(1000);
    });
