...
export const VOLUNTARYINFO = 'voluntaryInfo';
export const CONFIDENTIALINFO = 'confidentialInfo';
export const DATAPUBLICATIONINFO = 'dataPublicationInfo';
export const INFORMATION_LEAKAGE = 'informationLeakage';
