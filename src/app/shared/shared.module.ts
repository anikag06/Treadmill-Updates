...
@NgModule({
  declarations: [SlidesVideoComponent, SafeUrlPipe, FormSliderComponent, DateTimePickerComponent, MoodTrackerComponent],
  imports: [CommonModule, QuestionnaireModule, MaterialModule, FormsModule, OwlDateTimeModule, OwlNativeDateTimeModule],
  exports: [
  ...
  entryComponents: [SlidesVideoComponent, DateTimePickerComponent, MoodTrackerComponent],
})
