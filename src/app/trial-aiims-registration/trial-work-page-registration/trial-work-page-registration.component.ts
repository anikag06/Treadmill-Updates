...
import {
  ...
  OPEN_GROUP,
  OPEN_REGISTRATION_PATH, REGISTRATION_PATH, SIQ,
...
@Component({
  ...
  templateUrl: './trial-work-page-registration.component.html',
  styleUrls: ['./trial-work-page-registration.component.scss']
})
export class TrialWorkPageRegistrationComponent implements OnInit {
