...
export class ConversationsComponent implements OnInit, OnDestroy, DoCheck {
  ...
  loadConversation(current_id: boolean) {
    this.conversationsService.get('http://172.26.90.50:9000/api/v1/conversation/conversation/?conversation_id=' + this.conversation_id)
      .subscribe((res: any) => {
  ...
  current_history() {
    this.conversationsService.get('http://172.26.90.50:9000/api/v1/conversation/history/current/?conversation_id=' + this.conversation_id)
      .subscribe((res: any) => {
