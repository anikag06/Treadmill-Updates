...
export class LoadingBarDirective {
  ...
  showLoadingBar() {
    ...
    const custom_container = document.getElementById('custom_loading_container');
    ...
    this.element.nativeElement.insertAdjacentHTML('afterbegin', '<div id="custom_loading_container" class="h-100 w-100" style="position:absolute;background-color:rgba(0,0,0,1);z-index: 20;"></div>');
  }
