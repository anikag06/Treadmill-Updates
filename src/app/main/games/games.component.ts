...
export class GamesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.loadFileService
      .loadExternalScript(
        'assets/games/interpretation_bias_game/lib/jquery.cookie.js',
      )
      .then(() => {})
      .catch(() => {});
    this.loadFileService
      .loadExternalScript(
        'assets/games/interpretation_bias_game/lib/wordList.min.js',
      )
      .then(() => {})
      .catch(() => {});
    this.loadFileService
      .loadExternalScript(
        'assets/games/interpretation_bias_game/lib/wordBank.min.js',
      )
      .then(() => {})
      .catch(() => {});
    this.loadFileService
      .loadExternalScript(
        'assets/games/interpretation_bias_game/lib/hammer.min.js',
      )
      .then(() => {})
      .catch(() => {});
  }
