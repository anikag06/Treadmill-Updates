import { GAME_IDENTIFY_COGNITIVE_DISTORTION_CONSTANT } from '@/app.constants';

export const GAME_INTERPRETATION_BIAS = {
  heading: 'Interpretation bias game',
  description:
...
export const GAME_EXECUTIVE_CONTROL = {
  heading: 'Executive control game',
  description:
...
export const GAME_LEARNED_HELPLESSNESS = {
  heading: 'Learned helplessness game',
  description:
