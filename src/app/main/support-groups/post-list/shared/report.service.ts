...
export class ReportService {
  ...
  post_complaint(data: any) {
    return this.http.post(environment.API_ENDPOINT + POST_COMPLAINT, data);
  }
  ...
  comment_complaint(data: any) {
    return this.http.post(environment.API_ENDPOINT + COMMENT_COMPLAINT, data);
  }

  postThankYou(id: number) {
    return this.http.post(environment.API_ENDPOINT + POST_THANK, {
      post_id: id,
    });
  }
  nestedCommentThankYou(id: number) {
    return this.http.post(environment.API_ENDPOINT + NESTED_COMMENT_THANK, {
      nested_comment_id: id,
    });
  }
  commentThankYou(id: number) {
    return this.http.post(environment.API_ENDPOINT + COMMENT_THANK, {
      comment_id: id,
    });
  }
}
